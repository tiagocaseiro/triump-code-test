...
//The values in the vector should be semi random but the sum elements should be equal to total
...
//Complete function, the size of the vector should be equal to num elements
//The values in the vector should be semi random but the sum elements should be equal to total
std::vector <unsigned int> Function2(unsigned int total, unsigned int numElements)
{
